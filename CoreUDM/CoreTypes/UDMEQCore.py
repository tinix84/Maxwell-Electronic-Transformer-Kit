...
#                           Default Parameters
##############################################################
udmInfo = UDMInfo( name = "EQ_Core",
                    company = "ANSYS, Inc.",
                    purpose = "Create EQ Core and Windings",
...
#---------------------------------------------------------------------------------       
    def Refresh(self, funcLib, udmInParams, updatedParams, refreshModifiedPartsOnly, nonEditedPartRefIds):
        ...
        funcLib.SetPartName("EQ_Core_Bottom",XBaseCore)
        funcLib.SetPartColor(XBaseCore,0xa52a2a)
        MyUDMUtils.SetAttributes(XBaseCore, "EQ_Core_Bottom", funcLib)
        #MyUDMUtils.SetPartAttributes(XBaseCore,"EQ_Core_Bottom", "ferrite", 0xa52a2a, funcLib, "EQ_Core_Bottom")
        MirrorVect = UDPVector(0,0,1)
        MirrorPt = UDPPosition(0,0,0)
        TopCore = funcLib.DuplicateAndMirror(XBaseCore,MirrorPt,MirrorVect)
        
        funcLib.SetPartName("EQ_Core_Top",TopCore)
        funcLib.SetPartColor(TopCore,0xa52a2a)
        MyUDMUtils.SetAttributes(TopCore, "EQ_Core_Top", funcLib)
        #MyUDMUtils.SetPartAttributes(TopCore,"EQ_Core_Top", "ferrite", 0xa52a2a, funcLib, "EQ_Core_Top")
