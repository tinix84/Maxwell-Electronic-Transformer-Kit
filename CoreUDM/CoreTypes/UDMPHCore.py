...
#                           Default Parameters
##############################################################
udmInfo = UDMInfo( name = "PH_Core",
                    company = "ANSYS, Inc.",
                    purpose = "Create PH Core and Windings",
...
#---------------------------------------------------------------------------------       
    def Refresh(self, funcLib, udmInParams, updatedParams, refreshModifiedPartsOnly, nonEditedPartRefIds):
        ...
        DimD4 = 2*self._GetParamValueByName('D_4')
        DimD5 = 2*self._GetParamValueByName('D_5')
        ...
        funcLib.SetPartName("PH_Core_Bottom",XBaseCore)
        funcLib.SetPartColor(XBaseCore,0xa52a2a)
        MyUDMUtils.SetAttributes(XBaseCore, "PH_Core_Bottom", funcLib)
        #MyUDMUtils.SetPartAttributes(XBaseCore,"PH_Core_Bottom", "ferrite", 0xa52a2a, funcLib, "PH_Core_Bottom")
        MirrorVect = UDPVector(0,0,1)
        MirrorPt = UDPPosition(0,0,0)
        TopCore = funcLib.DuplicateAndMirror(XBaseCore,MirrorPt,MirrorVect)
        
        funcLib.SetPartName("PH_Core_Top",TopCore)
        funcLib.SetPartColor(TopCore,0xa52a2a)
        MyUDMUtils.SetAttributes(TopCore, "PH_Core_Top", funcLib)
        #MyUDMUtils.SetPartAttributes(TopCore,"PH_Core_Top", "ferrite", 0xa52a2a, funcLib, "PH_Core_Top")
