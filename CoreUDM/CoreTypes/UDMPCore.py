...
#                           Default Parameters
##############################################################
udmInfo = UDMInfo( name = "P_Core",
                    company = "ANSYS, Inc.",
                    purpose = "Create P Core and Windings",
...
#---------------------------------------------------------------------------------       
    def Refresh(self, funcLib, udmInParams, updatedParams, refreshModifiedPartsOnly, nonEditedPartRefIds):
        ...
        funcLib.SetPartName("P_Core_Bottom",XBaseCore)
        funcLib.SetPartColor(XBaseCore,0xa52a2a)
        MyUDMUtils.SetAttributes(XBaseCore, "P_Core_Bottom", funcLib)
        #MyUDMUtils.SetPartAttributes(XBaseCore,"P_Core_Bottom", "ferrite", 0xa52a2a, funcLib, "P_Core_Bottom")
        MirrorVect = UDPVector(0,0,1)
        MirrorPt = UDPPosition(0,0,0)
        TopCore = funcLib.DuplicateAndMirror(XBaseCore,MirrorPt,MirrorVect)
        
        funcLib.SetPartName("P_Core_Top",TopCore)
        funcLib.SetPartColor(TopCore,0xa52a2a)
        MyUDMUtils.SetAttributes(TopCore, "P_Core_Top", funcLib)
        #MyUDMUtils.SetPartAttributes(TopCore,"P_Core_Top", "ferrite", 0xa52a2a, funcLib, "P_Core_Top")
